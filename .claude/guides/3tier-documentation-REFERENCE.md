...
> **Full Reference** - Complete documentation with templates and examples
> **Quick Reference**: @.claude/guides/3tier-documentation.md (core concepts only)

## Purpose

The 3-Tier Documentation System organizes project documentation into hierarchical layers, optimizing token usage while providing comprehensive context.
