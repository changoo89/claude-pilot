# Gap Detection Guide (Full Reference)

> **Full Reference** - Complete gap detection methodology with examples and verification
> **Quick Reference**: @.claude/guides/gap-detection.md (core concepts only)
