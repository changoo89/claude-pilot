...
> **Full Reference** - Complete documentation with examples and verification
> **Quick Reference**: @.claude/guides/instruction-clarity.md (core patterns only)

## Purpose

Ensure LLMs can reliably understand conditional logic without misinterpretation.
