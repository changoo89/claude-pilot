# Requirements Verification Guide (Full Reference)

> **Full Reference** - Complete verification methodology with examples and templates
> **Quick Reference**: @.claude/guides/requirements-verification.md

## Purpose

Verify ALL user requirements are captured in the plan with 100% coverage.
