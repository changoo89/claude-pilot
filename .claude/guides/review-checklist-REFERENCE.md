...
> **Full Reference** - Complete checklist with all review items and templates
> **Quick Reference**: @.claude/guides/review-checklist.md (core items only)

## Purpose

Comprehensive review checklist for evaluating development plans. Reviews ensure plans are complete, well-structured, and ready for execution.
