...
### Fixed
- Add required `metadata` section to marketplace.json with pluginRoot
- Add homepage, repository, license, keywords fields to plugin entry
- Match official Claude Code marketplace schema format

## [4.1.4] - 2026-01-18

### Fixed
- Fix marketplace.json schema to match official Claude Code format
- Add missing $schema, version, description fields at root level
- Change owner.url to owner.email (required field)
- Change source from GitHub URL to local path "." (correct format)
