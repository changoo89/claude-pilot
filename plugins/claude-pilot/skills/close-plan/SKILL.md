...
- Step 1 TODO analysis: `Task: subagent_type: claude-pilot:validator` before user escalation
- Step 2 evidence verification: `Task: subagent_type: claude-pilot:validator`
- Step 3 docs sync: `Task: subagent_type: claude-pilot:documenter` (conditional)
