...
- Step 1.6/1.7/1.9 verification: `Task: subagent_type: claude-pilot:plan-reviewer` before user escalation
- Step 2.5 GPT review: Via gpt-delegation skill
- Step 3 auto-review: `Task: subagent_type: claude-pilot:plan-reviewer`
