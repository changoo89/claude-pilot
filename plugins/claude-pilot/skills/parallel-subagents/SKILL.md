...
Task: subagent_type: claude-pilot:coder, prompt: "Execute SC-1..."
Task: subagent_type: claude-pilot:coder, prompt: "Execute SC-2..."
Task: subagent_type: claude-pilot:coder, prompt: "Execute SC-3..."
```
...
for SC in $SC_LIST; do
    Task: subagent_type: claude-pilot:coder, prompt: "Execute $SC..."
done
```
...
Task: subagent_type: claude-pilot:security-analyst, prompt: Review security issues
```
...
```markdown
Task:
  subagent_type: claude-pilot:plan-reviewer
  prompt: |
...
```markdown
Task:
  subagent_type: claude-pilot:documenter
  prompt: |
