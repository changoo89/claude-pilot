...
- Step 1 scope validation: `Task: subagent_type: claude-pilot:researcher` (verify classification)
- Step 3 fix execution: `Task: subagent_type: claude-pilot:coder`
- Step 4 diff verification: `Task: subagent_type: claude-pilot:validator` (before user confirmation)
- Step 6 completion check: `Task: subagent_type: claude-pilot:validator`
