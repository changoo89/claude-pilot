...
Task: subagent_type: claude-pilot:tester, prompt: "Run test coverage analysis for current changes"
Task: subagent_type: claude-pilot:validator, prompt: "Run type-check and lint verification"
Task: subagent_type: claude-pilot:code-reviewer, prompt: "Perform deep code quality review"
```
...
Task: subagent_type: claude-pilot:documenter, prompt: "Update plan sections based on review findings"
```
