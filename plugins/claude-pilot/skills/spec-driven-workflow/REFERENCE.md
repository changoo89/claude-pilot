...
if ! all_checks_pass; then
  # Task: subagent_type: claude-pilot:explorer, prompt: "Investigate gaps in certainty checklist items: [missing items]"
  # Task: subagent_type: claude-pilot:researcher, prompt: "Research unknowns in certainty verification for: [missing items]"
...
if ! readiness_check_pass; then
  # Task: subagent_type: claude-pilot:explorer, prompt: "Investigate unknowns in readiness checklist: [missing items]"
  # Task: subagent_type: claude-pilot:researcher, prompt: "Research assumptions and dependencies for: [missing items]"
